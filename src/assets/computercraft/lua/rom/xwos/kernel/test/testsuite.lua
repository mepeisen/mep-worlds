...
return function(boot)
    ...
    boot.krequire('tests/xwos_kernel_fsro')
    boot.krequire('tests/xwos_kernel_modulesmgr')
    boot.krequire('tests/xwos_kernel_process')
    boot.krequire('tests/xwos_modules_appman_fsstorage')
    boot.krequire('tests/xwos_modules_appman_instance')
    boot.krequire('tests/xwos_modules_security_profile')
    boot.krequire('tests/xwos_modules_session_instance')
    boot.krequire('tests/xwos_modules_user_profile')
