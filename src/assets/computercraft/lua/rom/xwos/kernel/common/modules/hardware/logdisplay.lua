...
-- @return #display
M.createDisplay = function()
    local visible = true
    local redirectedTo = nil
    ...
    result.write = function(text)
      if visible and redirectedTo ~= nil then
        redirectedTo.write(text)
      end
    end
    ...
    result.blit = function(text, textColors, backgroundColors)
      if visible and redirectedTo ~= nil then
        redirectedTo.blit(text, textColors, backgroundColors)
      end
    end
    ...
    result.getCursorPos = function()
      if visible and redirectedTo ~= nil then
        return redirectedTo.getCursorPos()
      end
      return 0, 0
    end
    ...
    result.setCursorBlink = function(bool)
      if visible and redirectedTo ~= nil then
        redirectedTo.setCursorBlink(bool)
      end
    end
    ...
    result.setTextColor = function(color)
      if visible and redirectedTo ~= nil then
        redirectedTo.setTextColor(color)
      end
    end
    ...
    result.getTextColor = function()
      if visible and redirectedTo ~= nil then
        return redirectedTo.getTextColor()
      end
      return 0
    end
    ...
    result.setBackgroundColor = function(color)
      if visible and redirectedTo ~= nil then
        redirectedTo.setBackgroundColor(color)
      end
    end
    ...
    result.getBackgroundColor = function()
      if visible and redirectedTo ~= nil then
        return redirectedTo.getBackgroundColor()
      end
      return 0
    end
    ...
    result.getPosition = function()
      if visible and redirectedTo ~= nil then
        return redirectedTo.getPosition()
      end
    ...
    result.reposition = function(x, y, width, height)
      if visible and redirectedTo ~= nil then
        redirectedTo.reposition(x, y, width, height)
      end
    end
    ...
    result.setTextScale = function(scale)
      if visible and redirectedTo ~= nil then
        redirectedTo.setTextScale(scale)
      end
    end
